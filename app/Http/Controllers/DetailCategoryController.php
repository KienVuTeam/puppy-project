...
class DetailCategoryController extends Controller
{
    ...
    public function edit_breed($bre_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.breed', compact('title'))->with('edit_bre', $edit_bre);
        return $manager;
    }/* 
    public function edit_dog_name($dog_id)
    {
    ...
    */
    ...
    public function edit_national($nat_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.national', compact('title'))->with('edit_nat', $edit_nat);
        return $manager;
    }
    ...
    public function edit_group($gro_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.group', compact('title'))->with('edit_gro', $edit_gro);
        return $manager;
    }
    ...
    public function edit_activity_lv($act_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.activity', compact('title'))->with('edit_act', $edit_act);
        return $manager;
    }
    ...
    public function edit_barking_lv($bar_id)
    {
        $title = 'Page Edit Barking';
        $edit_bar = DB::table('cate_barking_lv_p')->where('barking_id', $bar_id)->get();
        $manager = view('Dashboard.EditCategory.barking', compact('title'))->with('edit_bar', $edit_bar);
        return $manager;
    }
    ...
    public function edit_characteristic($cha_id)
    {
        $title = 'Page Edit Characteristics';
        $edit_cha = DB::table('cate_characteristics_p')->where('characteristics_id', $cha_id)->get();
        $manager = view('Dashboard.EditCategory.characteristics', compact('title'))->with('edit_cha', $edit_cha);
        return $manager;
    }
    ...
    public function edit_coat_type($coa_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.coat', compact('title'))->with('edit_coa', $edit_coa);
        return $manager;
    }
    ...
    public function edit_size($siz_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.size', compact('title'))->with('edit_siz', $edit_siz);
        return $manager;
    }
    ...
    public function edit_trainability($tra_id)
    {
        ...
        $manager = view('Dashboard.EditCategory.trainability', compact('title'))->with('edit_tra', $edit_tra);
        return $manager;
    }
