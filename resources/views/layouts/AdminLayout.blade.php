...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- icon -->
    <link rel="shortcut icon" href="{{ asset('images/icons/admin.png') }}" type="image/x-icon">
...
<body class="cbp-spmenu-push">
    <div class="main-content">
                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="{{ route('show_post') }}"><i class="fa fa-angle-right"></i> Manage
                                            Post</a></li>
                                    <li><a href="{{ route('show_detail_category') }}"><i class="fa fa-angle-right"></i>Manage Category</a></li>
                                    <li><a href=""><i class="fa fa-angle-right"></i>Manage Libary</a></li>
                                    <li><a href="{{ route('manage_comment') }}"><i class="fa fa-angle-right"></i>Manage Comment</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
                            ...
                            <li class="header">Go to Website</li>
                            <li><a href="{{route('index_page')}} "><i class="fa fa-angle-right text-red"></i> <span>Home Page</span></a>
                            </li>
        ...
        <!--footer-->
        <div class="footer">
            <p> Design by <a href="#" target="_blank">Patrona Puppy Team</a></p>
        </div>
        <!--//footer-->
    </div>
