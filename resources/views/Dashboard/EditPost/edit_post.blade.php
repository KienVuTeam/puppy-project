...
<form action="{{ route('update_post', ['post_id']) }}" method="post" enctype="multipart/form-data">
    ...
    <div >
        <img src="{{ asset('upload/images') }}/{{ $data['Post'][0]->images }}" alt="" style="height: 100px;width: 100px;">
    ...
    <input type="datetime-local" placeholder="enter create_at" class="form-control " name="create_at" style="width:30%" value="{{ $data['Post'][0]->create_at }}">
    <br>
